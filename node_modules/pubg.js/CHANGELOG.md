...
## v3.9.0
 - [Added multi PlayerSeason function](https://github.com/ickerio/pubg.js/pull/18)
 - [Included attributes for PlayerSeason.relationships.player](https://github.com/ickerio/pubg.js/pull/19)
 - Some other old changes
 - Changed to axios from node-fetch
